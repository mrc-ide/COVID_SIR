...
plot_functions <- list(
  ...
  plot_sir_model = list(det_sir_fit, det_adap_sir_fit, stoch_sir_fit, true_history, incidence, "S"),
  plot_sir_model = list(det_sir_fit, det_adap_sir_fit, stoch_sir_fit, true_history, incidence, "I"),
  plot_sir_model = list(det_sir_fit, det_adap_sir_fit, stoch_sir_fit, true_history, incidence, "R"),
