# setwd("Z:/Yasin/COVID_SIR/src/plots")
...
# plot_sir_model(det_sir_fit, det_adap_sir_fit, stoch_sir_fit, true_history, incidence, "I")
...
plot_functions <- list(
  ...
  plot_sir_model_S = list(det_sir_fit, det_adap_sir_fit, stoch_sir_fit, true_history, incidence, "S"),
  plot_sir_model_I = list(det_sir_fit, det_adap_sir_fit, stoch_sir_fit, true_history, incidence, "I"),
  plot_sir_model_R = list(det_sir_fit, det_adap_sir_fit, stoch_sir_fit, true_history, incidence, "R"),
